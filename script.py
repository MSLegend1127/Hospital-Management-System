...
# ===================== EMAIL REMINDER =====================
def send_email_reminder(to_email: str, name: str, date_str: str):
    """Send simple appointment reminder via SMTP (Gmail example)."""
    ...
    try:
        ...
        messagebox.showerror("Email Error", "SMTP Authentication failed. Use an app password if using Gmail with 2FA.")
    except Exception as e:
